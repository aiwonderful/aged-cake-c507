...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aged-cake-c507
```

A live public deployment of this template is available at [https://aged-cake-c507.templates.workers.dev](https://aged-cake-c507.templates.workers.dev)
